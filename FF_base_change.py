...
def get_target_price(ticker, k):
    ...
    df = get_daily_ohlcv_from_base_new(ticker, base=8) #change your base time to 1:00am
...
def get_noise_k(ticker):
    ...
    df = get_daily_ohlcv_from_base_new(ticker, base=8) #chage your base time to 1:00am
