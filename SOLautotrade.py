...
while True:
    try:
        ...
        start_time_1 = get_start_time("KRW-SOL")
        ...
        if start_time < now < end_time - datetime.timedelta(seconds=10):
            ...
            if target_price < current_price and current_price < predicted_close_price:
                ...
                #print("volatility")
                if krw > 5000:
                    buy_result = upbit.buy_market_order("KRW-SOL", coins * 0.9995) #TargetVolatility/volatility/NumOfCoins*krw*0.9995,
                    post_message(myToken, "#breakthru", "SOL buy : " +str(buy_result))
        else:
            sol = get_balance("SOL")
            if sol > 5000/get_current_price("KRW-SOL"):
                sell_result = upbit.sell_market_order("KRW-SOL", sol)
                post_message(myToken, "#breakthru", "SOL sell : " +str(sell_result))
        time.sleep(1)
